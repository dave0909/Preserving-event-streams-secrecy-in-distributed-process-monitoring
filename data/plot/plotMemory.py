...
# Read the CSV file
df = pd.read_csv('../output/memory_usage.csv', decimal='.', header=0)
#df = pd.read_csv('../testResults/19.02.2025/teeMode/bpic2012/memory_usage_bpic2012.csv', decimal='.', header=0)
...
stats_df.to_csv('../output/memory_stats.csv', index=False)
#stats_df.to_csv('../testResults/19.02.2025/teeMode/bpic2012/memory_stats.csv', index=False)
...
# Save the plot
plt.savefig('../output/memory_usage.pdf')
#plt.savefig('../testResults/19.02.2025/teeMode/bpic2012/memory_usage.pdf')
# plt.show()