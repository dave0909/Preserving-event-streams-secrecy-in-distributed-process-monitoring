...
#df_volvo=df_volvo.head(len(df_simulation.index))
...
plt.plot(result_volvo['Durata Normalizzata'], result_volvo['Memory usage (MB)'], label='Default GC', color='red', linewidth=2, marker = '', markersize=2, alpha=0.7)

plt.plot(result['Durata Normalizzata'], result['Memory usage (MB)'], label='Custom GC 1', color='blue', linewidth=4, marker = '', markersize=2 , alpha=0.7)

# Create a line plot for the dataset volvo

# Create a line plot for the dataset sepsis
plt.plot(result_sepsis['Durata Normalizzata'], result_sepsis['Memory usage (MB)'], label='Custom GC 2', color='green', linewidth=2, marker='', markersize=2, alpha =0.7)
