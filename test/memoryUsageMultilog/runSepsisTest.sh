...
run_process_vault() {
    ...
    cd ../..
    python3 pv4.py ./data/PNML/sepsis.pnml ./workflowLogic/workflowLogic.go ./data/regoConstraints/sepsisConstraints ./complianceCheckingLogic/complianceCheckingLogic.go localhost:6066 ./data/input/extraction_manifest_sepsis.json false true 15200 false 200
