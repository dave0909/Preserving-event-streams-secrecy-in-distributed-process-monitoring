...
run_process_vault() {
    ...
    cd ../..
    python3 pv3.py ./data/PNML/trafficFinesrevised.pnml ./workflowLogic/workflowLogic.go ./data/regoConstraints/trafficFines ./complianceCheckingLogic/complianceCheckingLogic.go localhost:6066 data/input/extraction_manifest_traffic.json false true 561400 false 150
