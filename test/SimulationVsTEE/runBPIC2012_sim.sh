...
run_process_vault() {
    ...
    cd ../..
    python3 pv4.py ./data/PNML/bpic2012top10alpha.pnml ./workflowLogic/workflowLogic.go ./data/regoConstraints/bpic2012constraints ./complianceCheckingLogic/complianceCheckingLogic.go localhost:6066 data/input/extraction_manifest_bpic2012.json true true  275287 false 200
