...
run_process_vault() {
    ...
    cd ../..
    python3 processVaultCompilerSim.py ./data/PNML/motivating.pnml ./processVault/workflowLogic/workflowLogic.go ./data/regoConstraints/motivatingConstraints ./processVault/complianceCheckingLogic/complianceCheckingLogic.go localhost:6066 data/input/extraction_manifest_motivating.json true true 42740 false 200
