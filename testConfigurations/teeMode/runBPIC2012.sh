...
run_process_vault() {
    ...
    cd ../..
    python3  processVaultCompiler.py ./data/PNML/bpic2012top10alpha.pnml ./processVault/workflowLogic/workflowLogic.go ./data/regoConstraints/bpic2012constraints ./processVault/complianceCheckingLogic/complianceCheckingLogic.go localhost:6066 data/input/extraction_manifest_bpic2012.json false true  275287 false 200
