...
run_process_vault() {
    ...
    cd ../..
    python3  processVaultCompiler.py ./data/PNML/trafficFines.pnml ./processVault/workflowLogic/workflowLogic.go ./data/regoConstraints/trafficFines ./processVault/complianceCheckingLogic/complianceCheckingLogic.go localhost:6066 data/input/extraction_manifest_traffic.json false true 711840 false 200
