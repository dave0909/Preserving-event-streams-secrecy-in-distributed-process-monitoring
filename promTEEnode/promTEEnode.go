...
func (hs promTEENode) setHandler(w http.ResponseWriter, r *http.Request) {
	var c psm.Command
...
func (hs promTEENode) getHandler(w http.ResponseWriter, r *http.Request) {
	var c psm.Command
